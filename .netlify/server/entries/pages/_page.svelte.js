...
const ThemeSwitch = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${validate_component(Select, "Select").$$render(
      $$result,
      { label: "Select Theme", value: $theme },
      {
        value: ($$value) => {
          $theme = $$value;
          $$settled = false;
      ...
      {
        default: () => {
          return `${validate_component(Option, "Option").$$render($$result, { value: "system" }, {}, {
            default: () => {
              return `System`;
            }
          })}
	${validate_component(Option, "Option").$$render($$result, { value: "light" }, {}, {
            default: () => {
              return `Light`;
            }
          })}
	${validate_component(Option, "Option").$$render($$result, { value: "dark" }, {}, {
            default: () => {
              return `Dark`;
            }
          })}`;
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_theme = subscribe(theme, (value) => $theme = value);
  $$unsubscribe_theme();
  return `${$$result.head += `<meta name="${"color-scheme"}"${add_attribute("content", $theme == "light" ? "light" : "dark", 0)} data-svelte="svelte-1kjqxkf"><link rel="${"stylesheet"}"${add_attribute("href", $theme == "light" ? "/smui.css" : "/smui-dark.css", 0)} data-svelte="svelte-1kjqxkf">`, ""}
<body><h1>Welcome to SvelteKit</h1>
	<p>Visit <a href="${"https://kit.svelte.dev"}">kit.svelte.dev</a> to read the documentation</p>
	${validate_component(ThemeSwitch, "ThemeSwitch").$$render($$result, {}, {}, {})}
	${validate_component(Button_1, "Button").$$render($$result, { touch: true, variant: "outlined" }, {}, {
    default: () => {
      return `Click me`;
    }
  })}</body>`;
